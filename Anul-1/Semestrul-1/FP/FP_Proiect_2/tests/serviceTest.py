...
from Service.service import cautare_pachete_interval, cautare_pachete_dest_pret, cautare_pachete_sfarsit, \
...
from Domain.pachete import get_id,get_pret,get_locatie,get_data_plecare,get_data_sosire
